...
@Service
public class ValidaCardService {
    private static final Logger logger =  LoggerFactory.getLogger(ValidaCardService.class);
    ...
    /**
     * Valid a Credit Card number 3782 8224 6310 005
     */
    public static boolean validCC(String number) throws CardNumberException {
        int CardID;
        if ((CardID = getCardID(number)) != -1) {
            return validCCNumber(number);
        }
        throw new CardNumberException("Card number is invalid!");
    ...
    public static int getCardID(String number) {
        ...
        if (isNumber(number)) {
             ...
             */
                ...
                if (number.length() == 16) {
                    logger.info("is mastercard card.");
                    valid = MASTERCARD;
                }
            }
            /*
